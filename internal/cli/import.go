...
but do not stop the import.`,
  ...
  pse-edge-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  pse-edge-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | pse-edge-pp-cli import <resource> --input -`,
