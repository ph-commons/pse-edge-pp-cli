...
large datasets as it has no memory pressure.`,
  ...
  pse-edge-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  pse-edge-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  pse-edge-pp-cli export <resource> --format jsonl | jq '.id'`,
