...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("PSE_EDGE_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("PSE_EDGE_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "pse-edge-pp-cli", "config.toml"), nil
}
