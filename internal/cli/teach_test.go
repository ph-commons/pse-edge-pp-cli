...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"pse-edge-pp-cli auth login",
		"pse-edge-pp-cli doctor",
		"pse-edge-pp-cli help items",
		"pse-edge-pp-cli sync",
		"pse-edge-pp-cli profile list",
		"pse-edge-pp-cli feedback list",
		"pse-edge-pp-cli which",
		"pse-edge-pp-cli agent-context",
		"pse-edge-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"pse-edge-pp-cli recall",
		"pse-edge-pp-cli learnings",
		"pse-edge-pp-cli teach-pattern",
		"pse-edge-pp-cli teach-lookup",
		"pse-edge-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("pse-edge-pp-cli")); err == nil {
