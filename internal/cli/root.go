...
type rootFlags struct {
	...
	// invocation. Mirrors the PSE_EDGE_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "pse-edge-pp-cli",
		Short: `Pse Edge CLI — Agent-native Philippine Stock Exchange CLI — quotes, filings, and a local price history no free API serves.`,
		Long: `Pse Edge CLI — Agent-native Philippine Stock Exchange CLI — quotes, filings, and a local price history no free API serves.
...
Health check: run 'pse-edge-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("pse-edge-pp-cli {{ .Version }}\n")
	...
	rootCmd.AddCommand(newDisclosuresCmd(flags))
	...
	rootCmd.AddCommand(newNovelBreadthCmd(flags))
	...
	rootCmd.AddCommand(newFinancialsPromotedCmd(flags))
